const translations = {
    ...
    layerListHelp: {
        en: 'List of the different layers on the map, you can hide and show each one seperately',
    ...
    measureAreaHelp: {
        ...
        de: 'Hier können Sie die Größe einer Fläche messen',
    ...
    processHelp: {
        en: 'Here you find the link to open the same dataset in an external map viewer to process and further investigate.',
        de: 'Hier finden Sie den Link, um dasselbe Datensatz in einem externen Kartenviewer zu öffnen, um ihn weiter zu bearbeiten und zu untersuchen.',
        fr: "Voici le lien pour ouvrir le même jeu de données dans un visualiseur de carte externe pour le traiter et l'investiguer davantage.",
        it: 'Qui trovi il link per aprire lo stesso set di dati in un visualizzatore di mappe esterno per elaborarlo e investigarlo ulteriormente.',
    },
    printHelp: {
        en: 'Option to print the visible map region as PDF or image and export it',
        de: 'Option zum Drucken/Exportieren des sichtbaren Kartenausschnitts als PDF oder Bild',
        fr: 'Option pour imprimer/exporter la région de la carte visible en PDF ou en image',
        it: 'Opzione per stampare/esportare la regione mappa visibile come PDF o immagine',
    },
    editHelp: {
    ...
    regionFilter: {
        ...
        de: 'Filtern Sie die Daten nach Region, indem Sie auf eine der Formen klicken und dann auf der Karte zeichnen. Die Datenpunkte im Inneren werden eingefärbt und die außerhalb erscheinen in Grau. Das Diagramm berücksichtigt nur die Datenpunkte innerhalb der Form.',
